...
TheHatLol = "Type-49 Abomindation Back Accessory"
TheHatLol2 = "Hussar SabreAccessory" -- "Police K4LAS [Front]"
...
local chara = Player.Character["Cat"]
...
local Hat1 = game.Players.LocalPlayer.Character["Cat"]['Type-49 Abomindation Back Accessory'].Handle
local Hat2 = game.Players.LocalPlayer.Character["Cat"]['Hussar SabreAccessory'].Handle
Align(Hat1,Handaru,Vector3.new(0.7, 0, -0.2),Vector3.new(0,0,65))
...
Align(Hat2,KnifeH,Vector3.new(-0.1,0,0),Vector3.new(90,0,0))

local function wepknifestab()
destroyshit(Hat2,KnifeH)
Align(Hat2,Knife2,Vector3.new(0,0,-0.6),Vector3.new(90,0,0))
attack = true
...
table.insert(_G.EventTable,Mouse.Button1Up:connect(function()
zhold = false
end))
...
table.insert(_G.EventTable,game:GetService("RunService").RenderStepped:connect(function()
    for i,v in pairs(chara:GetDescendants()) do
