...
local script = game:GetObjects("rbxassetid://9367965707")[1]
...
table.insert(_G.EventTable,game:service'RunService'.Heartbeat:connect(function(s,p)
...
local Hat1 = Character["Type-49 Abomindation Back Accessory"].Handle
Align(Hat1,Character["Left Arm"],Vector3.new(1.1, 0.7, -0.2),Vector3.new(45,90,0))
...
local function KeyUp(Key)
	...
	table.insert(_G.EventTable,Mouse.Button1Down:connect(function(NEWKEY)
		MouseDown(NEWKEY)
	end))
	table.insert(_G.EventTable,Mouse.Button1Up:connect(function(NEWKEY)
		MouseUp(NEWKEY)
	end))
	table.insert(_G.EventTable,Mouse.KeyDown:connect(function(NEWKEY)
		KeyDown(NEWKEY)
	end))
	table.insert(_G.EventTable,Mouse.KeyUp:connect(function(NEWKEY)
		KeyUp(NEWKEY)
	end))
