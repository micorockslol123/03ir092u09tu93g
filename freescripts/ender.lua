...
local function SphereAura(bonuspeed, FastSpeed, type, pos, x1, y1, z1, value, color, outerpos)
	local type = type
...
local function chatfunc(text, color)
...
wait2 = false
combo = 1
table.insert(_G.EventTable,mouse.Button1Down:connect(function(key)
